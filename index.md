...
2. Proficient in the use of the R programming language to (1) build and analyze ecological models and (2) keep a reproducible electronic notebook of their work
